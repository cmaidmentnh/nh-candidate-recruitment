#!/usr/bin/env python3
"""
Comprehensive parser for 2022 NH election data
Extracts ALL results for EVERY candidate in EVERY town
No hardcoding - handles all edge cases programmatically
"""
        ...
        if (('District' in first_col and '(' in first_col) or 
            ...
            while scan_row < end_row:
                ...
                if row_candidates:
                    ...
                    # Special case: Check if next rows have unlabeled vote data (Rockingham District 1 format)
                    # This happens when votes appear immediately after candidates without town names
...
if __name__ == "__main__":
    ...
    with open('2022_nh_all_results_comprehensive.csv', 'w', newline='') as f:
    ...
    print(f"\n{'='*80}")
    print(f"Wrote {len(all_results)} vote records to 2022_nh_all_results_comprehensive.csv")
    ...
    # Determine expected seats (from earlier analysis)
    expected_seats = {
    ...
    # Write winners
    with open('2022_nh_winners_comprehensive.csv', 'w', newline='') as f:
